...
import AddNewItemPopover from "../../add-new-item/components/AddNewItemPopover";
...
const BoardGroup = ({
  ...
  return (
    <div className="bg-white dark:bg-black blue:bg-dark-blue px-[24px] py-[24px] rounded-lg shadow-sm w-full h-full max-h-[calc(100dvh-236px)] md:max-h-[calc(100dvh-275px)] overflow-auto">
      <div className="w-full flex justify-between gap-2 flex-wrap pb-4">
        <p className="font-medium text-gray-400 dark:text-gray-400 blue:text-gray-400">
          Items Count (Total):{" "}
      ...
      <div
        className={`h-full max-h-[calc(100dvh-380.8px)] md:max-h-[calc(100dvh-379.8px)] overflow-auto`}
      >
