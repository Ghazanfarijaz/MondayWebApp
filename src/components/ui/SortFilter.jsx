...
const SortFilter = ({
  ...
  return (
    <div className="relative sm:block flex justify-end" ref={dropdownRef}>
      <button
      ...
      <div
        className={`absolute right-0 mt-2 p-2 w-56 bg-white dark:bg-light-black blue:bg-light-blue rounded-lg shadow-lg z-10 border border-[#EAEAEA] dark:border-[#4E4E4E] blue:border-blue ${
